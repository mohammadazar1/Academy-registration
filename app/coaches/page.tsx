...
import { Coach, CoachSalary } from '../../types'
...
return (
  <div className="container mx-auto px-4 py-8">
    ...
    <form onSubmit={handleSubmit} className="mb-8">
      ...
      <div className="mb-4">
        <label htmlFor="phone_number" className="block text-gray-700 text-sm font-bold mb-2">رقم الهاتف</label>
        <input
          type="tel"
          id="phone_number"
          name="phone_number"
      ...
      <div className="mb-4">
        <label htmlFor="salary" className="block text-gray-700 text-sm font-bold mb-2">الراتب</label>
        <input
          type="number"
          id="salary"
          name="salary"
    ...
    <form onSubmit={handleSalarySubmit} className="mb-8">
      <div className="mb-4">
        <label htmlFor="coach_id" className="block text-gray-700 text-sm font-bold mb-2">المدرب</label>
        <select
          id="coach_id"
          name="coach_id"
